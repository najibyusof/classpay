...
class SponsorHomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      drawer: const RoleNavigationDrawer(userType: UserType.sponsor),
        ...
        child: ListView(
          ...
          children: [
            ...
            PaymentSummaryCard(
              ...
              message: 'View payment schedules and payment history.',
              onTap: () => context.push('/sponsor/payment-schedules'),
            ),
            ...
            const SizedBox(
              ...
              child: AppEmptyState(
                ...
                message:
                    'Classes available to your sponsored students will appear here.',
